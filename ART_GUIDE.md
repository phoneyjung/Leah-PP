...
- **ตัวละครผู้เล่น (แนวที่เลือก `concept-characters.jpg`):** ชิบิหัวโต ตาโตเป็นประกาย · เสื้อเชิ้ตขาว เข็มขัดหนังน้ำตาลกับกระเป๋าเล็ก ถุงมือน้ำตาล รองเท้าบูตน้ำตาล · **ผ้าคลุมไหล่สั้นสีม่วงล้วน** ตอนเจน (สีที่ไม่ซ้ำส่วนอื่น โค้ดเปลี่ยนเป็นสีบ้านเหลืองทอง/ฟ้า/เขียว/แดงได้ง่าย) · ไม่มีตราบนตัว (ตราอยู่บนธงและหน้าจอ) · ไม่มีหมวกติดหัว (หมวกเป็นของแยกวางทับ)
- เจนตัวละครผู้เล่นด้วย PixelLab **Pro Flash + Style image `style-kid.png`** (ตัดจากภาพต้นแบบ) ให้สไตล์ตรงกันทุกตัว
